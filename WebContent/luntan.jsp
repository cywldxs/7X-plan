...
<link href="files/luntan/styles.css" type="text/css" rel="stylesheet" />
...
<script src="files/luntan/data.js"></script>
...
<body>
	<div id="base" class="">
		...
		<div id="u2" class="ax_形状">
			<img id="u2_img" class="img " src="images/luntan/u2.png" />
			<!-- Unnamed () -->
		...
		<div id="u6" class="ax_图片">
			<img id="u6_img" class="img " src="images/luntan/u6.png" />
			<!-- Unnamed () -->
		...
		<div id="u8" class="ax_流程形状">
			<img id="u8_img" class="img " src="images/luntan/u8.png" />
			<!-- Unnamed () -->
		...
		<div id="u10" class="ax_图片">
			<img id="u10_img" class="img " src="images/luntan/u10.png" />
			<!-- Unnamed () -->
		...
		<div id="u12" class="ax_图片">
			<img id="u12_img" class="img " src="images/luntan/u10.png" />
			<!-- Unnamed () -->
		...
		<div id="u14" class="ax_图片">
			<img id="u14_img" class="img " src="images/luntan/u14.png" />
			<!-- Unnamed () -->
		...
		<div id="u16" class="ax_文本">
          ...
          out.println("<a href=\"http://172.17.201.21:8080/X-Plan/qunzu.jsp?&userno="+ userno + "\">高一</a>");
          %>
					</span>
				</p>
			</div>
		...
		<div id="u18" class="ax_文本">
			...
			<div id="u19" class="text">
				<p>
					<span style="font-family: 'Applied Font Regular', 'Applied Font';">高二</span>
				</p>
			</div>
		</div>
		...
		<div id="u20" class="ax_文本">
			...
			<div id="u21" class="text">
				<p>
					<span style="font-family: 'Applied Font Regular', 'Applied Font';">高三</span>
				</p>
			</div>
		</div>
		...
		<%
			...
			%>
			<img id="u28_img" class="img " <%out.println("src=\"" + img + "\"");%> />
			<!-- Unnamed () -->
		...
		<!-- Unnamed (菜单) -->
		<div id="u34" class="ax_菜单">
			<img id="u34_menu" class="img " src="images/zhuce/u35_menu.png"
				alt="u34_menu" />

			<!-- Unnamed (表格) -->
			<div id="u35" class="ax_表格">

				<!-- Unnamed (菜单项) -->
				<div id="u36" class="ax_表格单元">
					<img id="u36_img" class="img " src="images/zhuce/u37.png" />
					<!-- Unnamed () -->
		...
		<div id="u38" class="ax_形状">
			<img id="u38_img" class="img " src="images/zhuce/u39.png" />
			<!-- Unnamed () -->
		...
		<div id="u40" class="ax_形状">
			<img id="u40_img" class="img " src="images/zhuce/u41.png" />
			<!-- Unnamed () -->
		...
		<div id="u42" class="ax_形状">
			<img id="u42_img" class="img " src="images/zhuce/u43.png" />
			<!-- Unnamed () -->
		...
		<div id="u44" class="ax_形状">
			<img id="u44_img" class="img " src="images/zhuce/u45.png" />
			<!-- Unnamed () -->
